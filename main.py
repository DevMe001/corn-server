...
async def detect_image():
    ...
    varieties = ['Pioneer 3585', 'Dekalb 6919', 'Syngenta NK-6410', 'Unknown']
...
async def upload(body: dict) -> dict:
    ...
    percentagesFloat = [float(p) for p in formatted_percentages]

    # gt the highset percetages
    highest_percentage = max(percentagesFloat)

  
    return {
            'message': "Here is the predicted variety...",
            'variety': text,
            'accuracy':highest_percentage
        } 
